...
class PortalController extends Controller
{
    ...
    public function index_general()
    {
        ...
        //     SEOMeta::setCanonical('https://canariasexclusiva.com/escort');
        ...
        //     OpenGraph::setTitle('Escort, acompañantes en Canarias España - canariasexclusiva.com');
        //     OpenGraph::setUrl('https://canariasexclusiva.com/escort');
        //     OpenGraph::addProperty('type', 'articles');

        //     TwitterCard::setTitle('Escort, acompañantes en Canarias España - canariasexclusiva.com');
        //     // TwitterCard::setSite('@LuizVinicius73');

        //     JsonLd::setTitle('Escort, acompañantes en Canarias España - canariasexclusiva.com');
    ...
    public function show(Provincia $provincia, Municipio $municipio, Categoria $categoria, $user_id, Anuncio $anuncio)
    {
        ...
        # SEOMeta::setCanonical('https://canariasexclusiva.com');

        OpenGraph::setDescription($descripcion);
        OpenGraph::setTitle($titulo);
        #OpenGraph::setUrl('https://canariasexclusiva.com');
        OpenGraph::addProperty('type', 'articles');
