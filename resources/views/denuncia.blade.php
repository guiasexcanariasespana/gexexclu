...
@section('denunciaDescription', "Denucia de Perfil para {$anuncio->nombre} - {$anuncio->titulo} Escort en España para encuentros. Acompañantes chicas, chicos, transexuales, servicios de masajistas en España, no anuncios de sexo ni putas en España ")
@section('content')
...
<div class="container max-w-xl mx-auto">
    ...
    <div class="w-full my-5 ">
        <h1 class="text-center text-4xl my-10 font-bold"> Formulario de Denuncia de Perfil <br> 
        Perfil: ({{$anuncio->slug}}) {{$anuncio->nombre}} - {{$anuncio->titulo}}
    </h1>
...
como ejercer otros derechos dirigiéndote a info@canariasexclusiva.com. </p>
