...
<html data-theme="night" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="font-sans  text-gray-900 antialiased">
            <h1>El anuncio en <a class="text-color-red" href="{{config('app.url')}}"> canariasexclusiva.com</a>  está por vencer</h1>
            Hola
            <p>El anuncio {{$anuncio_str}} tiene fecha de finalización el día {{date('d-m-Y', strtotime($anuncio->fecha_caducidad))}}. </p>
