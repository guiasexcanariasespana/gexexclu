<div>
        <div class="relative aspect-video">
                        ...
                        <div class="py-2 px-2">
                          <h3 class="text-xl  font-extrabold">{{ \Illuminate\Support\Str::limit($anuncio->nombre, 50, $end='...') }}  <span class="inline-block ml-1"><img src="{{config('app.url')}}/img/banderas/Bandera de {{$anuncio->nacionalidad}}.svg" class="inline-block w-10" alt=""/> </span></h3>
                          <p class="text-md ">{{ \Illuminate\Support\Str::limit($anuncio->titulo, 50, $end='...') }}</p>
                        ...
                        <div class="inline-flex justify-start  text-xs px-2 py-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mx-1">
                               ...
                               <div style=";">
                                  ...
                                  <span class=" text-xs font-semibold pr-2">Verificada</span>
                                  </div>
                             @endif
