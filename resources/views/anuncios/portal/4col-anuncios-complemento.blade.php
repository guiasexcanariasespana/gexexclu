        <!--1/3 col -->
                    ...
                    <div class="hover:shadow-xl transition-transform transform hover:border-2 border-[{{$color_oro}}]" style="background-color: {{$color_oro}}" >
                       ...
                       <div class="h-[500px]">
                            <a href="{{route('portal.show', [$anuncio->provincia, $anuncio->municipio, $anuncio->categoria, $anuncio->user_id,  $anuncio])}}" class="no-underline hover:no-underline">
                                ...
                                <img  class="object-cover w-full h-full"src="{{ config('app.url') . '/images/anuncio/' . $anuncio->id . '/' . $anuncio->portada->nombre }}" loading="lazy" oncontextmenu="return false">
                                @endif
                        ...
                        <div class="inline-flex justify-start  text-xs px-2 py-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mx-1">
                               ...
                               <div style=";">
                                  ...
                                  <span class="text-black text-xs font-semibold pr-2">Verificada</span>
                                  </div>
                             @endif
                               @if ($anuncio->whatsapp == 'Si')

                                <span class="bg-[#55cd6c] text-white text-xs font-semibold pr-2 rounded-xl ">
